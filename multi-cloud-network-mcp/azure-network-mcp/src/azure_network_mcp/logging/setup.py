...
can be shipped as-is to Azure Monitor/Log Analytics, Splunk, Datadog, or an
ELK stack. Credentials, access tokens, and full Azure API payloads are
never logged -- only normalized, operationally-relevant fields.
"""
